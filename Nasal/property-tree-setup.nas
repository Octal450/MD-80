...
var Controls = {
	Dfgs: {
		Switches: {
			...
			artCover: props.globals.getNode("/controls/dfgs/art-cover"),
		},
	},
	Flight: {
...
var Instrumentation = {
	...
	Efis: {
		...
		Inputs: {
			...
			rangeNm: [props.globals.getNode("/instrumentation/efis[0]/inputs/range-nm"), props.globals.getNode("/instrumentation/efis[1]/inputs/range-nm")],
