...
We suggest **never** downgrading your aircraft for the best expirience. If you must do so, **you must** delete your `MD-80-config.xml` file. You may find it in `$FGHOME/Export`.
